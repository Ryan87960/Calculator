...
namespace Calculator
{
    ...
    {
        // 全域變數
        Calculate1 calculate = new Calculate1(); // firstNumber 儲存第一個數字，secondNumber 儲存第二個數字
        ...
        {
            Calculate1 firstnumber = new Calculate1(); //將輸入文字框轉換成浮點數，存入第一個數字的全域變數
        ...
        private void btnEqual_Click(object sender, EventArgs e)
        {
            ...
            Calculate1 secondnumber = new Calculate1(); //將輸入文字框轉換成浮點數，存入第二個數字的全域變數
